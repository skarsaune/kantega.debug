...
var Simple = (function(Simple) {
   ...
   */
  Simple.log = Logger.get('Centipede');
   ...
   * run function
   */
  Simple.module = angular.module('centipede', ['hawtioCore'])
  ...
  Simple.module.run(function(workspace, viewRegistry, layoutFull) {
    ...
    viewRegistry["centipede"] = layoutFull;
    ...
    workspace.topLevelTabs.push({
      ...
      href: function() { return "#/centipede"; },
      isActive: function(workspace) { return workspace.isLinkActive("centipede"); }
